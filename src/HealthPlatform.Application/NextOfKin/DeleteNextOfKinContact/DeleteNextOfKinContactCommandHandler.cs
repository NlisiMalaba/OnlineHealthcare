...
public sealed class DeleteNextOfKinContactCommandHandler(
    ICurrentUserAccessor currentUser,
    IPatientRepository patientRepository,
    INextOfKinRepository nextOfKinRepository)
    : IRequestHandler<DeleteNextOfKinContactCommand>
{
    public async Task Handle(DeleteNextOfKinContactCommand request, CancellationToken ct)
    {
        ...
        await nextOfKinRepository.DeleteAsync(contact, ct);
    }
