...
public static class NotificationEventTypes
{
    ...
    public const string CarePlanTaskDueReminder = "wellness.care_plan_task_due_reminder";
    public const string CarePlanReviewReminder = "wellness.care_plan_review_reminder";
}
